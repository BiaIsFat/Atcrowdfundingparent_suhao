                ...
                <span><i class="glyphicon glyphicon glyphicon-tasks"></i> 权限管理 <span class="badge"
                        ...
                        <ul style="margin-top:10px;">
                            <li style="height:30px;">
                                <a href="${APP_PATH}/user.tolist.htm" style="color:red;"><i class="glyphicon glyphicon-user"></i> 用户维护</a>
                            </li>
                            <li style="height:30px;">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td colspan="6" align="center">
                                    ...
                                    &lt;%&ndash;<li class="active"><a href="#">1 <span class="sr-only">(current)</span></a></li>
                                    <li><a href="#">2</a></li>
                                    <li><a href="#">3</a></li>
                                    <li><a href="#">4</a></li>
                                    ...
                                    <html test="${page.pageno!=page.totalno}">
    ...
    function queryPageUser(pageno) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                ...
                return true; //表示继续发送请求
            },
            success: function (result) {

                layer.close(loadingIndex);//关闭加载图标
                if (result.success) {
                   ...
                   contentBar+='<li><a href="#" onclick="pageChange('+(page.pageno-1)+')">上一页</a></li>';
                    ...
                    for (var i=1;i<page.pageno==num;i++){
                        contentBar+='<li ';
                        if(page.pageno==i){
